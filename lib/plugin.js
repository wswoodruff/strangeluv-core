...
module.exports = (server, options, next) => {
    ...
    server.register(Inert, (err) => {
        ...
        // Create middlewares
        const webpackDevMiddleware = WebpackDevMiddleware(options.compiler, options.assets);
        const webpackHotMiddleware = WebpackHotMiddleware(options.compiler, options.hot);
        ...
        server.ext('onRequest', (request, reply) => {
            ...
            WebpackDevMiddleware(raw.req, raw.res, (err) => {
        ...
        server.ext('onRequest', (request, reply) => {
            ...
            WebpackHotMiddleware(raw.req, raw.res, (err) => {
