...
module.exports = {
    register: async (server, options) => {
        ...
        // Create middlewares
        const devMiddleware = Promisify(WebpackDevMiddleware(options.compiler, options.assets));
        const hotMiddleware = Promisify(WebpackHotMiddleware(options.compiler, options.hot));
